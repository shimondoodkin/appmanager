...
CPPPATH_NODE = '/mnt/hda1/base/nave/installed/0.4.7/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/local/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/mnt/hda1/base/nave/installed/0.4.7/lib/node'
LIBPATH_NODE = '/mnt/hda1/base/nave/installed/0.4.7/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/local/bin/g++']
NODE_PATH = '/mnt/hda1/base/nave/installed/0.4.7/lib/node'
PREFIX = '/usr/local'
PREFIX_NODE = '/mnt/hda1/base/nave/installed/0.4.7'
